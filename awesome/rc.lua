...
-- THEME
beautiful.init("/home/ghoul/.config/awesome/themes/jack2/theme.lua")
...
shifty.config.tags = {
	["1-term"]   = { init = true, position = 1, layout = awful.layout.suit.fair},
	["2-web"]    = { position = 2, layout = awful.layout.suit.fair             },
	["3-term"]   = { position = 3, layout = awful.layout.suit.tile             },
	["4-emel"]   = { position = 4, layout = awful.layout.suit.fair             },
	["5-thun"]   = { position = 5, layout = awful.layout.suit.tile             },
	["6-mail"]   = { position = 6, layout = awful.layout.suit.tile             },
	["7"]        = { position = 7, layout = awful.layout.suit.fair             },
	["8"]        = { position = 8, layout = awful.layout.suit.fair             },
	["9"]        = { position = 9, layout = awful.layout.suit.fair             },
}

-- shifty: tags matching and client rules
shifty.config.apps = {
	{ match = { "Namoroka", "luakit"         }, tag = "2-web",                 },
	{ match = { "mutt", "Lanikai"            }, tag = "6-mail",                },
	{ match = { "thunar"			 }, tag = "5-thun",                },
	{ match = { "emelfm2"			 }, tag = "4-emel",                },
...
spacerwidget = widget({ type = "imagebox" })
	spacerwidget.image = image("/home/ghoul/.config/awesome/themes/jack2/spacer.png")
...
clockwidget = widget({ type = "textbox" })
	...
	function cal_gett()
		local fp = io.popen("remind /home/ghoul/.reminders")
		local rem = fp:read("*a")
		fp:close()
...
weatherwidget = widget({ type = "textbox" })
	...
	function (widget, args)
		if args["{tempc}"] == "N/A" then
			...
			weatherwidget:add_signal('mouse::enter', function () weather_n = { naughty.notify({ title = "" .. colblu .. "─────────── Weather BXL ───────────" .. coldef .. "", text = "" .. colbblu .. "Wind    : " .. args["{windkmh}"] .. " km/h " .. args["{wind}"] .. "\nHumidity: " .. args["{humid}"] .. " %\nPressure: " .. args["{press}"] .. " hPa" .. coldef .. "", border_color = "#1a1a1a", timeout = 0, hover_timeout = 0.5 }) } end)
...
weatherwidget:buttons(awful.util.table.join(awful.button({}, 3, function () awful.util.spawn ( browser .. " http://www.kmi.be/meteo/view/nl") end)))
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey,           }, "r",                     function () awful.util.spawn("dmenu_run -b -fn 'terminus' -nb '#000000' -nf '#9bcd32' -sb '#4c4b49' -sf '#9bcd32'") end),
	...
	awful.key({ modkey, "Control" }, "r",                     function () naughty.notify({ text = cal_gett(), border_color = "#000000", timeout = 20, hover_timeout = 0.5 }) end),
	-- file managers
